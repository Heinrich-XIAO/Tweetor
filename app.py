...
def submit_flit() -> Response:
    ...
    if user_turbo == 0 and (len(content) > 280 or "*" in content or "_" in content):
        return render_template("error.html", error="You do not have PerchPerspectives Turbo.")
    ...
    if meme_template_id and meme_text0 and meme_text1:
        ...
        'username': "PerchPerspectives_official",
        'password': "PerchPerspectives_password",
        'text0': meme_text0,
        'text1': meme_text1
        })
